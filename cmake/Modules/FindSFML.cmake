...
if(SFML_STATIC_LIBRARIES)
    ...
    if(NOT ${FIND_SFML_AUDIO_COMPONENT} EQUAL -1)
        ...
        # find libraries
        find_sfml_dependency(OPENAL_LIBRARY "OpenAL" openal openal32 libOpenAL32)
        find_sfml_dependency(SNDFILE_LIBRARY "SndFile" libsndfile)
        message (STATUS "Found OpenAL ${OPENAL_LIBRARY}")
        find_sfml_dependency(OGG_LIBRARY "Ogg" ogg libogg)
        message (STATUS "Found Ogg ${OGG_LIBRARY}")
        find_sfml_dependency(VORBIS_LIBRARY "Vorbis" vorbis libvorbis)
        message (STATUS "Found Vorbis ${VORBIS_LIBRARY}")
        find_sfml_dependency(VORBISFILE_LIBRARY "VorbisFile" vorbisfile libvorbisfile)
        message (STATUS "Found VorbisFile ${VORBISFILE_LIBRARY}")
        find_sfml_dependency(VORBISENC_LIBRARY "VorbisEnc" vorbisenc libvorbisenc)
        message (STATUS "Found VorbisENC ${VORBISENC_LIBRARY}")
        find_sfml_dependency(FLAC_LIBRARY "FLAC" FLAC)
        message (STATUS "Found FLAC ${FLAC_LIBRARY}")

        # update the list
        set(SFML_AUDIO_DEPENDENCIES ${OPENAL_LIBRARY} ${FLAC_LIBRARY} ${VORBISENC_LIBRARY} ${VORBISFILE_LIBRARY} ${VORBIS_LIBRARY} ${OGG_LIBRARY} ${SNDFILE_LIBRARY})
