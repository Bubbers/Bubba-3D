...
public:
     ...
     */
    void update(float deltaTime, float distanceToCam, ParticleConf &conf, chag::float4x4 modelMatrix);
...
private:
    ...
    chag::float3 relativeLocation;
    chag::float4x4 parentModelMatrix;
};
