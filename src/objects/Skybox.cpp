...
bool Skybox::init(const string &posXFilename, const string &negXFilename, const string &posYFilename,
    ...
    m_shaderProgram = ResourceManager::getShader(SKYBOX_SHADER_NAME);
...
void Skybox::render() {
    ...
    m_shaderProgram.setUniform1i("cubeMapSampler", 0);
    m_shaderProgram.setUniformMatrix4fv("modelMatrix", m_skyMesh.m_modelMatrix);
    ...
    GLuint m_shaderProgram = this->m_shaderProgram.shaderID;
    ...
    //glUniformMatrix4fv(glGetUniformLocation(this->m_shaderProgram.shaderID, "viewProjectionMatrix"), 1, false, &viewProj.c1.x);
    //glUniformMatrix4fv(glGetUniformLocation(this->m_shaderProgram.shaderID, "viewProjectionMatrix"), 1, false, &viewProj.c1.x);
